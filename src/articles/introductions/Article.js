...
const Introductions = () => {
  ...
  return <Bass>
    ...
    <Hr type={2}/>
    <TechCard title="Software Collaboration Tools" style={{borderRadius: '15px'}} src={github}>
    ...
    <TechCard title="Various Web Frameworks" src={react}>
    ...
    <TechCard title="Database Technologies" src={sql}>
