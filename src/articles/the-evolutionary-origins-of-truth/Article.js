...
let Article = (props) => {
    return (
        <Bass>
            <Text variant="h2" serif>The Evolutionary Origins of Truth</Text>
            <Hr type={1}/>
            <Text variant="h4"><b>Why I Believe in Free Will and Determinism</b></Text>
            <br/>
            <Text>As we live and walk around in our world, we perceive different things through our senses, and so over time, we come to form certain conclusions about the things that we see. Through my own experiences, I have come to the belief that I have a free will, and that the universe is deterministic.</Text>
            <br/>
            <Text variant="h4"><b>The Contradiction of Free Will and Determinism</b></Text>
            <br/>
            <Text>However, for us who hold these beliefs, there is an obvious contradiction that is staring us in the face, for if *deterministic* means that the materials in the universe are governed by the laws of physics, then we people, who are made of materials, must also be governed by the same laws, and if we are governed by the laws of physics, then how can we be governed by our own free wills?
            <br/>
            <br/>
            ...
            <br/>
            <Text variant="h4"><b>Our Shitty Metaphysics of Truth</b></Text>
            <br/>
            <Text>So the reason why I believe that what we believe is a contradiction (I'm claiming that how people behave, and not what they say indicates what they truly they believe, btw), is really not the fault of what we believe, but instead is just the result of us having a shitty metaphysics of truth, as in our modern culture we seem to only be salient about one aspect of truth (the binary and absolute), and not the other. But I posit that truth is actually multifaceted, and that there are actually two different kinds of truth *formal*, and *darwinion*.
            <br/>
            <br/>
            ...
            <br/><br/>
            And since these beliefs have both stood the test of time, and proven to be beneficial for us, we ought to call them truth, as these things are the fundamental purpose of truth, and that since these ideas are more fundamental than logic itself, logic telling us that that they are a contradiction is not a reason for us to abandon them.</Text>
            <br/>
            <Text variant="h4"><b>Works Cited</b></Text>
            <br/>
            <Text>"Pragmatism: A New Name for Some Old Ways of Thinking", by William James</Text>
        </Bass>
    )
}
