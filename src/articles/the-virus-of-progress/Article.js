...
let TheVirusOfProgress = (props) => {
    return (
        <Bass>

        <Text variant="h1" serif>The Virus of Progress</Text>
        <Hr type={1}/>

        <Text variant="h4"><b>Liberality, Happiness, and Goodness</b></Text>
        <br/>
        <Text>
        ...
        <Text variant="h4"><b> The Cause of the Bullshitization of our Society</b></Text>
        <br/>
        <Text>
            ...
            <ol>
                <li>The citizens have a love of material wealth.</li>
                <li>The citizens, through an investigation of the natural world, have discovered a machine which transmutes matter into material wealth, which can be improved upon with further investigation of the natural world (basically the industrial and scientific revolutions).</li>
            </ol>

            For when these elements come into contact, the unstoppable "progress" is set into motion. The citizens, due to their love of material wealth, seek to acquire these matter transmuting machines, but also dissatisfied with the current amount of weath these machines generate, invest their profits into the further research of these machines, to acquire even more material wealth, and this cycle continues until the world is consumed (see peak oil, peak phosphorus, water shortage, climate change, etc.), and so, a by-product of progress is a constant improvement of these machines, which is manifest as increasing efficiency.
            <br/>
            <br/>
        ...
        <Text variant="h4"><b>The Judgement of our Current State of Affairs</b></Text>
        <br/>
        <Text>
        ...
        <br/>
        <Text>"Bullshit Jobs", by David Graeber</Text>
