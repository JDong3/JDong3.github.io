...
let Speculation = (props) => {
    return (
        <Bass>
            ...
            <Text variant="h2" serif>Scientific Theories as Truth</Text>
            <Hr type={1}/>
            <Text variant="h4"><b>Motivation</b></Text>
            <br/>
            <Text>
            ...
            <br/><br/>
            What we normally think of as reality is actually not the real thing, but our perception. So in a sense our notions and beliefs are not based in some absolute reality, but they are necessarily based in our perception which is influenced by ourselves and our culture. (record here)</Text>
            <br/>
            <Text variant="h4"><b>The Map Territory Relationship</b></Text>
            <br/>

            <Text>The map is not the territory, just by virtue of its size its much smaller than the territory, so you can’t expect all of details of the territory to be contained in the map. And If there were a map that contained all of the details of the territory, it would necessarily just be the territory itself.
            ...
            Representations are analogous to maps, not maps of territory, but maps of reality. We suspect that these representations are like reality, but we can’t expect them to be reality, because at the end of the day its our percreption, and not reality that we’ve created these representations from.</Text>

            <br/>

            <Text variant="h4"><b>Old and New Scientific Theories</b></Text>
            <br/>
            <Text>I want to examinine two different “scientific theories” for why things fall. According to the Greeks, the world is made of four elements, earth, air, fire, and water. Now each of these elements have a natural place, like earth is beneath us, and air is above us. However upon being disturbed, these elements wish to return to their natural places, so if you throw a rock upwards, it falls back down because the rock is made of earth, and the earth wishes to return to its natural place.
            <br/><br/>
            ...
            <br/><br/>
            I want to reiterate that saying logic is magical is not me telling you to not use logic, because we are not concerned about whether logic is magical or not, only that it works.</Text>
            <br/>
            <Text variant="h4"><b>Conclusions?</b></Text>
            <br/>

            <Text>Its a truism that all roads lead to Darwinism. Our idea of usefulness is related to the things that we wan’t. And at least in theory, the things that we desire, should be related to things that increase our chances of survival. And scientific theories seem to be things that increase our chances of getting the things that we want. For example, if we want to launch a satellite into orbit, we need to have good scientific theories on the behaviour of rockets, orbital trajectories, composite materials, etc.
            <br/><br/>
            And in this context it becomes clear that there is no pressure in the systems of scientific theory formation that attempts to remove magical thinking, if that’s even possible. But the main pressure is just to come up with theories that work well enough so that we can do whatever it is that we want to do.</Text>
